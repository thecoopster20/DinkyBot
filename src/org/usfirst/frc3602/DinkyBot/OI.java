...
public class OI {
    ...
    public OI() {
    	...
    	JoystickButton pickupOutToggle = new JoystickButton(gamepad, 3);
    	JoystickButton feederToggle = new JoystickButton(gamepad, 4);
    	JoystickButton lightToggle = new JoystickButton(gamepad, 6);
